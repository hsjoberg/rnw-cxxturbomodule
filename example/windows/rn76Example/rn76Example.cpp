// rn76Example.cpp : Defines the entry point for the application.
//

#include "pch.h"
#include "rn76Example.h"

#include "AutolinkedNativeModules.g.h"

#include "NativeModules.h"

#include "../../../windows/rn76/rn76-jsi.h"
...
_Use_decl_annotations_ int CALLBACK WinMain(HINSTANCE instance, HINSTANCE, PSTR /* commandLine */, int showCmd) {
  ...
  settings.PackageProviders().Append(winrt::make<facebook::react::Rn76PackageProvider>());
  ...
  appWindow.Title(L"Rn76Example");
  appWindow.Resize({1000, 1000});

  // Get the ReactViewOptions so we can set the initial RN component to load
  auto viewOptions{reactNativeWin32App.ReactViewOptions()};
  viewOptions.ComponentName(L"Rn76Example");
